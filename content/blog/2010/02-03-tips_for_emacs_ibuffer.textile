...
<notextile><code class="language-lisp">(global-set-key (kbd "C-x C-b") 'ibuffer) ;; Use Ibuffer for Buffer List
</code></notextile>
...
<notextile><code class="language-lisp">(setq ibuffer-saved-filter-groups
      '(("home"
...
<notextile><code class="language-lisp">(add-hook 'ibuffer-mode-hook 
	  '(lambda ()
...
<notextile><code class="language-lisp">(setq ibuffer-expert t)
</code></notextile>
...
<notextile><code class="language-lisp">(setq ibuffer-show-empty-filter-groups nil)
</code></notextile>
