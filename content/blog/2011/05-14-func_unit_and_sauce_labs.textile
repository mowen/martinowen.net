...
tags: [testing, javascript, funcunit]
created_at: 2011/05/14
kind: article
excerpt: How to use the FuncUnit web application testing framework with cloud-based Selenium service Sauce Labs
--- 
...
<notextile><code class="language-javascript">FuncUnit = {
    browsers: [
        JSON.stringify({ 
            username: "<%= h '<your Sauce Labs username>' %>",
            "access-key": "<%= h '<your Sauce Labs Api Key>' %>",
            os: "Windows 2003",
            browser: "firefox",
            "browser-version": "3.6.",
            name: "My Tests",
            "user-extensions-url": "http://<%= h '<your server>' %>/funcunit/java/user-extensions.js"
        })
    ],
